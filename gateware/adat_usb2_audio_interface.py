...
from fir_convolver           import FIRConvolver, ConvolutionMode
...
class USB2AudioInterface(Elaboratable):
    ...
    def wire_up_dac(self, m, usb_to_channel_stream, dac_extractor, dac, lrclk, dac_pads, fir=None, enable_fir=None):
