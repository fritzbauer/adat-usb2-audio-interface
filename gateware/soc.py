 ...
 #       from litex.soc.cores.i2s import S7I2S
  #  
   #     #self.check_if_exists(name)
    ...
    def add_i2s(self, name="i2s", sys_clk_freq=None, toolchain=None):
        ...
        self.submodules.analyzer = analyzer = LiteScopeAnalyzer(i2s.analyzer_signals,
            depth        = 1024,
            clock_domain = "sys",
            samplerate   = 20e6,
        ...
        self.bus.add_slave("audio", self.i2s.bus, SoCRegion(origin=0xb1000000, size=i2s_mem_size, cached=False))
        self.add_csr("audio", use_loc_if_exists=True)
        self.irq.add("audio", use_loc_if_exists=True)
