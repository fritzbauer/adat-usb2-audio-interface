...
class USB2AudioInterface(Elaboratable):
    ...
    USB2_NO_CHANNELS     = 4
    USB1_NO_CHANNELS     = 4 + USB2_NO_CHANNELS
    ...
    def elaborate(self, platform):
        ...
        usb2_sof_counter, usb2_to_usb1_fifo_level, usb2_to_usb1_fifo_depth = \
            self.create_sample_rate_feedback_circuit(m, usb1, usb1_ep1_in, None, None)
       ...
       #     DomainRenamer("usb")(USBStreamToChannels(usb2_number_of_channels))
        ...
        m.submodules.usb1_channel_stream_combiner = usb1_channel_stream_combiner = \
            DomainRenamer("usb")(ChannelStreamCombiner(self.USB1_NO_CHANNELS, self.USB2_NO_CHANNELS))

        m.submodules.usb1_channel_stream_splitter = usb1_channel_stream_splitter = \
            DomainRenamer("usb")(ChannelStreamSplitter(self.USB1_NO_CHANNELS, self.USB2_NO_CHANNELS))
        ...
        for i in range(1, 5):
            ...
            if self.USE_ADAT_TX | self.USE_ADAT_RX:
...
#
    ...
    def create_sample_rate_feedback_circuit(self, m: Module, usb1, usb1_ep1_in, usb23, usb32_ep1_in):
        #
        # USB rate feedback
        #
